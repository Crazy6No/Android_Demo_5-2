package com.example.consult2_activity;
...
public class SelfInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        batchText = (TextView) findViewById(R.id.batchText);
        sourceAreaText = (TextView) findViewById(R.id.sourceAreaText);
        targetAreaText = (TextView) findViewById(R.id.targetAreaText);


        selfInfoPreferences = getSharedPreferences("selfInfo", Context.MODE_PRIVATE);
    ...
    public void showDialog() {//弹出对话框
        ...
        View
                view = this.getLayoutInflater().inflate(R.layout.dialog_self_info_edit, new
                LinearLayout(this));
        ...
        ArrayAdapter<String> areaAdapter = new ArrayAdapter<String>(this, R.layout.spinner_item_year, provinces);
